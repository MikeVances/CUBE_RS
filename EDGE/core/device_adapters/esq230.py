...
class ESQ230Adapter(DeviceAdapter):
    ...
    def __init__(self) -> None:
        self._registers: Dict[str, RegisterInfo] = {
            ...
            "output_power": RegisterInfo(0x1005, "output_power", ValueType.INTEGER, unit="Вт", description="Выходная мощность"),
            "output_torque": RegisterInfo(0x1006, "output_torque", ValueType.INTEGER, unit="Н·м", description="Выходной крутящий момент"),
            "running_speed": RegisterInfo(0x1007, "running_speed", ValueType.INTEGER, unit="Гц", description="Рабочая скорость"),
