...
class TestModuleAliases:
    ...
    def test_original_modules_still_accessible(self):
        ...
        from core import security_manager, types
        from modbus import async_client, gateway, gateway_typed
    ...
    def test_requirements_cleanup(self):
        ...
        for req_file in redundant_requirements:
            ...
            ), f"Redundant requirements file still exists: {req_file}"
...
class TestDeduplicationResults:
    ...
    def test_import_times_not_degraded(self):
        ...
        try:
            start_time = time.time()
            from deploy_gateway.modbus import (  # noqa: F401
                AsyncModbusClient as AliasedClient,
            )
            from deploy_gateway.modbus import (  # noqa: F401
                TypedModbusGateway as AliasedGateway,
            )
