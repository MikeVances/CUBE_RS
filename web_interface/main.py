...
from core.types import (
    ModbusRequest, ModbusResponse, ModbusFunctionCode, 
    ModbusDevice, ModbusConnectionInfo, ModbusConnectionType,
    DeviceId
)
...
async def get_system_stats() -> SystemStats:
    ...
    error_rate = (gateway.error_counter / total_requests * 100) if total_requests > 0 else 0
...
async def register_device(device_config: DeviceConfig):
    ...
    return {"message": "Device registered successfully", "device_id": device_config.device_id}
